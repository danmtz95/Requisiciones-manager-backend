...
from requisiciones.models import Requisicion, RequesicionTipo, CategoriaEstado, RequesicionEstatus, RequisicionEstado, ReporteCompras, CotizacionCompras, EstatusCompras
